...
namespace COMP_003A_L01_A2
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // anothr example of the three primary variable related activities declaring, assigning and retrieving)
            ...
            // score = "Generic User"; // will fail to compile because you are assigning a string value to an interger varriable
            // score = "0"; // will still fail to compile because the "0" is still assigned as a string - enclosed in the double quotes
            score = 0; //works
            score = 4; // you can also reassign values to the varriable as long as they are within scope and not constant
            score = 11;
            score = -1564;


            /* reading from variable does not change it */
            int a;
            int b;
            ...
            Console.WriteLine("The current value of a: " + b);
            ...
            // result: What is your name, human? Saul
